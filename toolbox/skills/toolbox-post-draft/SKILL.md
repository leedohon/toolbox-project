...
2. Read the indexed `AGENTS.md`, `toolbox/AGENTS.md`, and `toolbox/guides/post-drafting-guide.md`. For a new module or merge/split task, also read `toolbox/guides/tool-module-compatibility.md` and `toolbox/guides/ai-index-guide.md`. Do not load old release HTML unless debugging a regression.
