...
- 게시·배포 운영: [Blogger 게시 운영 및 자동화 기준](BLOGGER-OPERATIONS.md)
...
게시 또는 릴리스 요청에는 Blogger 게시글 반영, 게시글 URL 동기화, Git 커밋·푸시, GitHub Pages 배포 확인이 기본 운영 흐름으로 포함됩니다. 실행 권한이 있으면 에이전트가 직접 처리합니다.
