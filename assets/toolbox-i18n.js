(function () {
  ...
  const exact = new Map(Object.entries({
    ...
    'Base64로 인코딩': 'Encode to Base64', '결과 복사': 'Copy result', '초기화': 'Reset',
    ...
    'JSON 파일 저장': 'Save JSON file', '전체 비우기': 'Clear all', 'Excel 표 미리보기': 'Excel table preview',
    ...
    '이미지 저장': 'Save image', '바코드 하단 텍스트 표시': 'Show text below barcode',
    ...
    '숫자 뽑기': 'Pick numbers', '범위와 개수를 정해 주세요.': 'Set the range and quantity.', '뽑은 숫자': 'Picked numbers',
    ...
    '모자이크 편집기': 'Mosaic editor', '브러시 크기': 'Brush size', '모자이크 강도': 'Mosaic strength',
    '드래그해서 모자이크를 적용할 이미지': 'Image canvas for painting mosaic', '한 단계 되돌리기': 'Undo one step', '원본으로 초기화': 'Reset to original', 'PNG 저장': 'Save PNG',
