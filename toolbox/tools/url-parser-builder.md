...
## 기능
- URL 입력 복귀 버튼과 `Alt + U`, 블로그 주소 예제 `Alt + S`, 쿼리 전체 비우기
- 중복 키와 순서를 보존한 쿼리 항목 JSON 복사
- Ctrl/⌘+Enter URL 분석과 화면 단축키 안내
...
- UTM·광고 클릭 식별자 등 흔한 추적 쿼리 일괄 제거
- 중복 키 순서를 유지하는 쿼리 이름순 정렬
- UTM과 중복 태그가 포함된 블로그 주소 예제
...
- `Alt + R`로 URL과 편집 중인 쿼리 입력을 초기화한다.
