...
## 기능
- 좌표·거리 결과를 구조화 JSON으로 복사하고 파일로 저장
- 좌표·거리 결과 TXT 저장과 Ctrl/⌘+Enter 계산
- Alt+S로 서울·제주 대표 좌표 예제 적용
...
- 서울과 제주 좌표를 한 번에 넣는 거리 예제
- 출발·도착 좌표를 Google 지도 경로로 열기
...
- `Alt+U`로 첫 좌표 입력에 돌아가고 `Alt+S`로 서울·제주 예제를 계산한다.
